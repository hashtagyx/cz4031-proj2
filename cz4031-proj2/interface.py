...
from PyQt5.QtWidgets import QMainWindow, QVBoxLayout, QWidget, QPushButton, QTextEdit, QMessageBox, QScrollArea, QLabel, QComboBox, QTextBrowser, QTableWidget, QTableWidgetItem, QHeaderView, QDialog, QApplication
import matplotlib
